...
const create = async (req, res) => {
  ...
  try {
    ...
    Capture the essence of the Halo universe by emphasizing the unique and futuristic characteristics of the Spartan, ensuring a modern and recognizable interpretation. The focus should be on the Spartan's interaction with the desert environment and the distinct portrayal of their armor, facial features, and the act of holding the helmet.`;
